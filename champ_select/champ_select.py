...
class Avatar :
    ...
    def __init__(self, screen):
        ...
        self.avatar1_image = pygame.transform.scale(self.avatar1_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.avatar2_image = pygame.transform.scale(self.avatar2_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.avatar3_image = pygame.transform.scale(self.avatar3_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.avatar4_image = pygame.transform.scale(self.avatar4_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.avatar5_image = pygame.transform.scale(self.avatar5_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.avatar6_image = pygame.transform.scale(self.avatar6_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.avatar7_image = pygame.transform.scale(self.avatar7_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.avatar8_image = pygame.transform.scale(self.avatar8_image, (math.ceil(screen.get_height() / 6), math.ceil(screen.get_width() / 4)))
        ...
        self.button = pygame.transform.scale(self.button, (math.ceil(screen.get_height() / 2), math.ceil(screen.get_width() / 10 )))
